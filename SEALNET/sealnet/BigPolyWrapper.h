...
namespace Microsoft
{
    namespace Research
    {
        namespace SEAL
        {
            ...
            and coefficient bit width (which can be read with <see cref="CoeffBitCount"/>), and all coefficients in 
            a BigPoly have the same bit width. The coefficient count and bit width of a BigPoly is set initially by 
            the constructor, and can be resized either explicitly with the <see cref="Resize()"/> function, or implicitly 
            ...
            all coefficients. Each coefficient is stored in an identical format to <see cref="BigUInt"/>, with the least 
            ...
            prevent undefined behavior. The <see cref="Pointer"/> function returns a pointer to the first System::UInt64 
            of the array.
            </para>
            ...
            <see cref="BigPolyArray" /> objects, as these polynomials need to have the leading coefficient equal to zero 
            to be considered valid by classes such as <see cref="Evaluator"/> and <see cref="Decryptor"/>. For this purpose 
            ...
            <para>
            An aliased BigPoly (which can be determined with <see cref="IsAlias"/>) is a special type of BigPoly that does 
            ...
            <see cref="Pointer"/> and the coefficients returned by the indexer property. When it is known a resize will 
            ...
            */
            ...
            public:
                ...
                */
                ...
                <seealso cref="GetSignificantCoeffCount()">See GetSignificantCoeffCount() to instead ignore the leading 
                ...
                */
                ...
                <seealso cref="GetSignificantCoeffBitCount()">See GetSignificantCoeffBitCount() to instead get the number 
                ...
                */
                ...
                <seealso cref="CoeffUInt64Count">See CoeffUInt64Count to determine the number of System::UInt64 values 
                ...
                */
                ...
                <seealso cref="CoeffCount">See CoeffCount to instead return the coefficient count regardless of the number
                ...
                */
                ...
                <seealso cref="CoeffBitCount">See CoeffBitCount to instead return the coefficient bit count regardless of 
                ...
                */
                ...
                <exception cref="System::InvalidOperationException">if BigPoly is an alias and the assigned BigPoly is too 
                ...
                */
                ...
                <para>
                The string description of the polynomial must adhere to the format returned by <see cref="ToString()"/>, which 
                ...
                <exception cref="System::InvalidOperationException">if BigPoly is an alias and the assigned polynomial is too 
                large to fit the current coefficient count and/or bit width</exception>
                */
                ...
                */
                ...
                <exception cref="System::ArgumentOutOfRangeException">if startCoeff is not within 
                ...
                */
                ...
                <exception cref="System::ArgumentOutOfRangeException">if startCoeff is not within 
                [0, <see cref="CoeffCount"/>]</exception>
                <exception cref="System::ArgumentOutOfRangeException">if length is negative or start_coeff + length is not
                within [0, <see cref="CoeffCount"/>]</exception>
                */
                ...
                */
                ...
                <exception cref="System::ArgumentNullException">if stream is null</exception>
                <exception cref="System::InvalidOperationException">if BigPoly is an alias and the loaded polynomial is too 
                large to fit the current coefficient count and/or bit width</exception>
            ...
            internal:
                ...
                */
                ...
                /**
                <summaryInitializes the BigPoly to use the specified std::uint64_t* as backing array.</summary>
                
                <remarks>
                Initializes the BigPoly to use the specified std::uint64_t* as backing array. This function
                creates an owned BigPoly that wraps an aliased seal::BigPoly.
                </remarks>
                <param name="coeffCount">The number of coefficients</param>
                <param name="coeffBitCount">The bit width of each coefficient</param>
                <exception cref="System::ArgumentException">if either coeffCount or coeffBitCount is negative</exception>
                */
                BigPoly(int coeffCount, int coeffBitCount, std::uint64_t *value);
